 ...
 */
class getLLoginFormAuthenticatorService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Security\LLoginFormAuthenticator' shared autowired service.
     *
     * @return \App\Security\LLoginFormAuthenticator
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Security'.\DIRECTORY_SEPARATOR.'LLoginFormAuthenticator.php';

        return $container->privates['App\\Security\\LLoginFormAuthenticator'] = new \App\Security\LLoginFormAuthenticator(($container->services['router'] ?? $container->getRouterService()));
    }
}
